...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <active>true</active>
        <description>TCRD City Update</description>
        <formula>OR(ISCHANGED(City_Reference__c),ISNEW())</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <description>TCRD Country Update</description>
        <formula>OR(ISCHANGED(Country_Reference__c),ISNEW())</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <active>true</active>
        <description>TCRD State Update</description>
        <formula>OR(ISCHANGED(State_Reference__c),ISNEW())</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
