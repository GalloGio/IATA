...
OR (
ISNEW(),
ischanged(Issue_Categorization__c ), 
ISCHANGED( Issue_Sub_Category__c ), 
ISCHANGED( Amount_LC__c ), 
ISCHANGED( Back_Valued__c ) , 
ISCHANGED( Back_Valuation_Date__c ), 
ISCHANGED( OperationCPS__c ), 
ISCHANGED( Country__c ), 
ISCHANGED( Region__c ), 
ISCHANGED (Currency__c), 
ISCHANGED(Amount_USD_auto__c), 
ISCHANGED(Back_Valuation_Date__c), 
ISCHANGED(Back_Valuation_Reporting_Month__c), 
ISCHANGED(Reporting_Month__c)))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
