...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        ...
        <description>Update the Status of BIN Range every time Effective From Date changes to a present or past date.</description>
    ...
    <rules>
        <fullName>Update BIN Range Status Active</fullName>
        <actions>
    ...
    <rules>
        <fullName>Update BIN Range Status In Progress</fullName>
        <actions>
