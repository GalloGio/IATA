...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
  ...
  OR(
    ...
    Parent.RecordType.DeveloperName = &quot;Airline_Coding_Application&quot;,
    Parent.RecordType.DeveloperName = &quot;ID_Card_Application&quot;,
    Parent.RecordType.DeveloperName = &quot;Invoicing_Collection_Cases&quot;,
    Parent.RecordType.DeveloperName = &quot;IATA_Financial_Review&quot;,
    Parent.RecordType.DeveloperName = &quot;SIDRA_Lite&quot;,
    Parent.RecordType.DeveloperName = &quot;OSCAR_Communication&quot;,
    Parent.RecordType.DeveloperName = &quot;FDS_ASP_Management&quot;,
    Parent.RecordType.DeveloperName = &quot;FDS_ICCS_Bank_Account_Management&quot;,
    Parent.RecordType.DeveloperName = &quot;FDS_ICCS_Membership_Management&quot;,
    Parent.RecordType.DeveloperName = &quot;FDS_ICCS_Product_Management&quot;,
    Parent.RecordType.DeveloperName = &quot;CNS_Collection_Process&quot;
  ),
  NOT(ISPICKVAL(Parent.New_interaction__c ,&quot;New email&quot;)),
  NOT(ISPICKVAL(Parent.New_interaction__c ,&quot;New email closed case&quot;))
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
  ...
  OR(
    ISPICKVAL(Parent.New_interaction__c ,&quot;New email&quot;),
    ISPICKVAL(Parent.New_interaction__c ,&quot;New email closed case&quot;)
  )
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND( CreatedById &lt;&gt;  Parent.OwnerId ,  not(Parent.IsClosed),  NOT(ISPICKVAL(Parent.Status, &apos;Pending Closure&apos;)),  OR(  Parent.RecordType.Name = &quot;Cases - Global&quot;,   Parent.RecordType.Name = &quot;Cases - Europe&quot;,  Parent.RecordType.Name = &quot;Cases - Americas&quot;,  Parent.RecordType.Name = &quot;Cases - Africa &amp; Middle East&quot;,  Parent.RecordType.Name = &quot;Cases - Asia &amp; Pacific&quot;,  Parent.RecordType.Name = &quot;Cases - China &amp; North Asia&quot;,  Parent.RecordType.Name = &quot;Cases - SIS Help Desk&quot;,   Parent.RecordType.Name = &quot;Complaint (IDFS ISS)&quot;, Parent.RecordType.Name = &quot;Invoicing Collection Cases&quot;, Parent.RecordType.Name = &quot;Cases - IFG&quot;, Parent.RecordType.DeveloperName = &quot;CS_Process_IDFS_ISS&quot;, Parent.RecordType.DeveloperName = &quot;ID_Card_Application&quot;, Parent.RecordType.DeveloperName = &quot;ID_Card_Mass_Application&quot; ))</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
