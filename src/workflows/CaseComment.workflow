...
OR( 
AND(Parent.RecordType.DeveloperName = &quot;SIDRA&quot;, 
...
NOT(ISPICKVAL(Parent.New_interaction__c ,&quot;New email closed case&quot;)) )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
...
Parent.RecordType.DeveloperName =&quot;SIDRA_Lite&quot;,
Parent.RecordType.DeveloperName = &quot;OSCAR_Communication&quot;), 
OR(ISPICKVAL(Parent.New_interaction__c ,&quot;New email&quot;) ,
ISPICKVAL(Parent.New_interaction__c ,&quot;New email closed case&quot;)) )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
