...
//Methods
import getLstProviders from '@salesforce/apex/PortalServicesStartupHotlistCtrl.getLstProviders';
...
export default class PortalServicesStartupHotlistSearchTab extends LightningElement {
    ...
    getFundingStages(){
        this.fsLoading = true;
        getPickListValues({ sobj: 'SH_Account_Role_Detail__c', field: 'Funding_Stage__c' }).then(result => {
    ...
    getTechnologies(){
        ...
        getPickListValues({ sobj: 'SH_Account_Role_Detail__c', field: 'Technology__c' }).then(result => {
    ...
    getFocusAreas(){
        this.faLoading = true;
        getPickListValues({ sobj: 'SH_Account_Role_Detail__c', field: 'Focus_Areas__c' }).then(result => {
    ...
    getCategories(){
        ...
        getPickListValues({ sobj: 'SH_Account_Role_Detail__c', field: 'Tags_Of_Categories__c' }).then(result => {
