...
const NAME_FIELD = "MasterLabel";
const URL_FIELD = "Link__c";
const DESCRIPTION_FIELD = "Description__c";
...
export default class cwFooter extends LightningElement {
  ...
  label = labels.labels();
	...
	get AirlinesName() {
		return this.metadataAirlines.data ? this.metadataAirlines.data[NAME_FIELD] : "";
	}
	get AirlinesURL() {
		return this.metadataAirlines.data ? this.metadataAirlines.data[URL_FIELD] : "";
	}
	...
	get AviationName() {
		return this.metadataAviation.data ? this.metadataAviation.data[NAME_FIELD] : "";
	}
	get AviationURL() {
		return this.metadataAviation.data ?  this.metadataAviation.data[URL_FIELD] : "";
	}
	...
	get twitterName() {
		return this.metadataTwitter.data ? this.metadataTwitter.data[NAME_FIELD] : "";
	}
	get twitterURL() {
		return this.metadataTwitter.data ? this.metadataTwitter.data[URL_FIELD] : "";
	}
	...
	get FacebookName() {
		return this.metadataFacebook.data ? this.metadataFacebook.data[NAME_FIELD] : "";
	}
	get FacebookURL() {
		return this.metadataFacebook.data ? this.metadataFacebook.data[URL_FIELD] : "";
	}
	...
	get LinkedinName() {
		return this.metadataLinkedIn.data ? this.metadataLinkedIn.data[NAME_FIELD] : "";
	}
	get LinkedinURL() {
		return this.metadataLinkedIn.data ? this.metadataLinkedIn.data[URL_FIELD] : "";
	}
	...
	get YoutubeName() {
		return this.metadataYoutube.data ? this.metadataYoutube.data[NAME_FIELD] : "";
	}
	get YoutubeURL() {
		return this.metadataYoutube.data ? this.metadataYoutube.data[URL_FIELD] : "";
	}
	...
	get RSSName() {
		return this.metadataRSS.data ? this.metadataRSS.data[NAME_FIELD] : "";
	}
	get RSSURL() {
		return this.metadataRSS.data ? this.metadataRSS.data[URL_FIELD] : "";
	}
	...
	get LegalName() {
		return this.metadataLegal.data ? this.metadataLegal.data[NAME_FIELD] : "";
	}
	get LegalURL() {
		return this.metadataLegal.data ? this.metadataLegal.data[URL_FIELD] : "";
	}
	...
	get PrivacyName() {
		return this.metadataPrivacy.data ? this.metadataPrivacy.data[NAME_FIELD] : "";
	}
	get PrivacyURL() {
		return this.metadataPrivacy.data ? this.metadataPrivacy.data[URL_FIELD] : "";
	}
	...
	get FooterTitleDescription() {
		return this.metadataFooterTitle.data ? this.metadataFooterTitle.data[DESCRIPTION_FIELD] : "";
	}
	...
	get FooterCopyrightDescription() {
		return this.metadataFooterCopyright.data ? this.metadataFooterCopyright.data[DESCRIPTION_FIELD] + ' ' + new Date().getFullYear() + '. ' +this.label.all_rights_reserved + '.' : "";
	}
