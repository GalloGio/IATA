    ...
    connectedCallback() {
        ...
        .then(results => {
            this.columns = [
                ...
                {label: results.Subject, fieldName: 'CaseURL', type: 'url', initialWidth: 350, typeAttributes: {label: {fieldName: 'Subject'}, target:'_self', tooltip: {fieldName: 'Description'}}, cellAttributes: {class: 'slds-text-title_bold text-black'}},
