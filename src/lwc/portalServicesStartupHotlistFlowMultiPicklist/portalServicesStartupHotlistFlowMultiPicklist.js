...
import ChooseAny from '@salesforce/label/c.CSP_SH_ChooseAny';

export default class PortalServicesStartupHotlistFlowMultiPicklist extends LightningElement {
    ...
    getOptions(){
        getPickListValues({ sobj: 'SH_Account_Role_Detail__c' , field: this._field }).then(result => {
