...
export default class TidsEntries extends NavigationMixin(LightningElement) {
  ...
  connectedCallback() {
    ...
    console.log('Profile:',this.visibleBusinessProfile);
    console.log('Business:',this.visibleBusinessSpecialization);
    console.log('Document:',this.visibleSupportingDocuments);
    console.log('Submit:',this.visibleSubmitApplication);
  ...
  changeAddressContact() {
    ...
    console.log('this.tidsUserInfo.tidsAccount',JSON.stringify(this.tidsUserInfo.tidsAccount));
    console.log('changeAddressContact:this.userType',this.userType);
    ...
    if(this.userType === 'vetting') {
      ...
      //this.startMenu('contact');
    }
  }
  
  addressContactDetailsCallback(result,reportchange) {
    console.log('addressContactDetailsCallback:result',JSON.stringify(result));
    setSfTidsInfo(JSON.parse(JSON.stringify(result)));
    this.startMenu(reportchange);
    console.log(reportchange,true);
    //this.startMenu('contact');
  }
  ...
  startMenu(optionSelected) {
    this.reset();
    console.log('startMenu:optionSelected',optionSelected);
  ...
  save(props) {
    ...
    console.log('applicationsettings.applicationType',applicationsettings.applicationType);
    saveSettings({
      accountId: accountId,
