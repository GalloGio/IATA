        ...
        action.setCallback(this, function(response){
            ...
            if(state === 'SUCCESS') {
                ...
                if(! $A.util.isEmpty(result)) {
                    ...
                    if(! $A.util.isEmpty(result['GADM User'])) {

                        let accessStatus = result['GADM User'];

                        if(accessStatus === 'Granted') {// access status is granted, check account access status
                    ...
                    if(! $A.util.isEmpty(result)['status']) {
                        ...
                        if(status === 'Active') {//status active
                            ...
                            if(! $A.util.isEmpty(result)['effective']) {
                                ...
                                //TODO:new label for error message
                                component.set('v.accessMessage', $A.get("$Label.c.GADM_No_Access"));
                                component.set('v.accessDenied', true);
                            }
