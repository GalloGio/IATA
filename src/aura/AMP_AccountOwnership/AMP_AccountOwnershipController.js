    ...
    handleUpdateAccount : function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                console.log("firing error event for index [" + index + "] w message " + errors[0].pageErrors[0].message);
                
                var errorEvent = $A.get("e.c:AMP_OwnershipError");
                errorEvent.setParams({ "errorMessage": errors[0].pageErrors[0].message, "index":index });
                errorEvent.fire();
