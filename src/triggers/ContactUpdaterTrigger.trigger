...
trigger ContactUpdaterTrigger on AMS_Person__c (after update) {
    Map<String, List<AMS_employee__c>> empsPerPerson = new  Map<String, List<AMS_employee__c>>();
