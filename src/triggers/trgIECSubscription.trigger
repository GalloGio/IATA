/**  
  ...
  *   - 20160623: Sonny Leman: add call to processEBCSubscription, to update related Zuora__CustomerAccount
  *
  */
trigger trgIECSubscription on Zuora__Subscription__c (after insert, after update) {
    ...
    if(Trigger.isInsert && Trigger.isAfter) {
        ...
        trgIECEBC_SubscriptionHandler.processEbcSubscription(Trigger.newMap);
    }
