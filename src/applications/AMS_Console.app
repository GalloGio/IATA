...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        ...
        <whitelistedDomains>iata--AmsDev1.cs86.my.salesforce.com</whitelistedDomains>
    </consoleConfig>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <isNavAutoTempTabsDisabled>false</isNavAutoTempTabsDisabled>
    <isNavPersonalizationDisabled>false</isNavPersonalizationDisabled>
    <isServiceCloudConsole>true</isServiceCloudConsole>
    <label>AMS Console</label>
    <preferences>
    ...
    <tabs>IATA_Code_Loader</tabs>
    <tabs>Code_Range__c</tabs>
    <tabs>standard-Chatter</tabs>
    <tabs>APXTConga4__Conga_Template__c</tabs>
    <tabs>SIDRA_Lite_Mass_Approval</tabs>
    <tabs>standard-Knowledge</tabs>
    <tabs>Voucher_Management</tabs>
    <tabs>AMS_Voucher_Region__c</tabs>
    <tabs>Purge_IATA_Code_Process</tabs>
    <tabs>Annual_Certificate_Campaign</tabs>
    <tabs>AMS_Account_Role__c</tabs>
    <tabs>ANG_Agency_Risk_Calculation__c</tabs>
    <tabs>ANG_Risk_Event_Configuration__c</tabs>
    <tabs>ANG_Risk_Event_Type__c</tabs>
    <workspaceConfig>
        <mappings>
