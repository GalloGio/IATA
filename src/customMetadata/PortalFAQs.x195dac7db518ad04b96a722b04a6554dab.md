...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>x195dac7db518ad04b96a722b04a6554dab</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Akreditasyon Ücretleri</value>
    </values>
    <values>
        <field>DataCategoryLabel_ar__c</field>
        <value xsi:type="xsd:string">رسوم الاعتماد</value>
    </values>
    <values>
        <field>DataCategoryLabel_de__c</field>
        <value xsi:type="xsd:string">Akkreditierungsgebühren</value>
    </values>
    <values>
        <field>DataCategoryLabel_en_US__c</field>
        <value xsi:type="xsd:string">Accreditation Fees</value>
    </values>
    <values>
        <field>DataCategoryLabel_es__c</field>
        <value xsi:type="xsd:string">Tasas de acreditación</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">认证费用</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Accreditation_Fees_Accreditation_IATAN_US</value>
    </values>
    <values>
        <field>DataTopicName__c</field>
        <value xsi:type="xsd:string">Accreditation_IATAN_US</value>
    </values>
    <values>
